...
# If the given username already exists, this function will give 'False' back
# if doesn't then create a new player in 'players' dict
...
# Check if there is more riddle, if not then return False,
# if there are return the riddle where player is
...
# Create leaderboard and gives it back, or if there was no player,
